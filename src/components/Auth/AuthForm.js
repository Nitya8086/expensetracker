...
const AuthForm = () => {
  ...
  const submitHandeler = async (event) => {
    ...
    if (isLogin) {
      url =
        "https://identitytoolkit.googleapis.com/v1/accounts:signInWithPassword?key=AIzaSyCrilnK_PD53JrvxxK3CSr_mN-b3fzjV40";
    } else {
      ...
      url =
        "https://identitytoolkit.googleapis.com/v1/accounts:signUp?key=AIzaSyCrilnK_PD53JrvxxK3CSr_mN-b3fzjV40";
    }
    try {
      ...
      <form onSubmit={submitHandeler}>
        ...
        {!isLogin && (
          <div className={classes.control}>
            ...
            <input type="password" required ref={confirmPasswardInputRef} />
          </div>
        )}
